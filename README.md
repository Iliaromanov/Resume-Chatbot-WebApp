...
To see the development and training process of the neural network model used in this web app, or to use the CLI version of the Chatbot go to https://github.com/Iliaromanov/Resume-Chatbot-Model
