...
def get_response():
    ...
    payload = {"sentence": sentence, "known_words": words}
...
def store_feedback():
    ...
    client = MongoClient(
        f"mongodb+srv://ilibotMongo:{password}@iliabot.a2hry.mongodb.net/iliabotFeedback?retryWrites=true&w=majority" #noqa
    )
